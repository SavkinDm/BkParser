...
public class FootballMatch extends Event {
    ...
    public FootballMatch(int Id, String team1, String team2, String kindOfSport, String bkName, long startTime,
    ...
    public FootballMatch(int Id, String team1, String team2, String kindOfSport, String bkName, int startTime) {
        super(Id, team1, team2, kindOfSport, bkName, startTime);
    }

    public FootballMatch(int id, String name, String team1, String team2, String kindOfSport, String bkName, long startTime) {
        super(id, name, team1, team2, kindOfSport, bkName, startTime);
    }

    public FootballMatch(int Id, String team1, String team2, String kindOfSport, String bkName, long startTime, HashMap<String, HashMap<Double, Double>> totalsOnThisEvent) {
        super(Id, team1, team2, kindOfSport, bkName, startTime);
    }
