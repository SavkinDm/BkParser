...
public class ParserService {
    ...
    @Autowired
    LigaStavokRestTemplate ligaStavokRestTemplate;

    @Autowired
    MelBetRestTemplate melBetRestTemplate;

    @Autowired
    MostBetRestTemplate mostBetRestTemplate;

    @Autowired
    OlimpBetRestTemplate olimpBetRestTemplate;
